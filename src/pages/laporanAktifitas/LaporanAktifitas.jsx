...
import { getLaporanAktivitas } from "../../redux/actions/transaksiAction";
import logo from "../../assets/logo2.png";
import Swal from "sweetalert2";
import { OrbitProgress } from "react-loading-indicators";
import DokumentasiLaporanAktifitas from "./DokumentasiLaporanAktifitas";

export default function LaporanAktifitas() {
  ...
  const handleSubmit = (e) => {
    ...
    if (!startMonth || !endMonth || !format || !year1 || !year2 || !jenis) {
      Swal.fire({
        icon: "warning",
