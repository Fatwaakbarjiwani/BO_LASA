...
import { getCampaignOperator, getDetailCampaign, tutupCampaignActive } from "../../../redux/actions/campaignAction";
import { OrbitProgress } from "react-loading-indicators";
import { setModalEditActive } from "../../../redux/reducers/campaignReducer";

export default function TableCampaignOperator() {
  ...
  useEffect(() => {
    if (
      ...
      dispatch(getCampaignOperator(pN1 - 1));
    }
  }, [dispatch, pN1, modalCreateActive, modalEditActive, isLoading]);
